  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <a href="<?=Base_url()?>Admin/Testimony/add" class="btn btn-primary btn-lg">Add New Testimony / Quote</a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">All Testimonies</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <th width="1%">#</th>
                  <th width="20%">Name</th>
                  <th width="30%">Testimony / Quotes</th>
                ...
                foreach($testimonies as $testimony){?>
                    <tr>
                        ...
                        <td><img src="<?=Base_url()?>media/Testimony/<?=$testimony->image?>" width="50%"></td>
                        <td>
                            <a href="#" onclick="getById(<?=$testimony->id?>); return false" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></a>
                            <a href="#" onclick="getDelete(<?=$testimony->id?>); return false" class="btn btn-primary btn-sm"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                <?php }?>
                </tbody>
...
<script>
  function getDelete(id)
  {
    ...
    .then((willDelete) => {
      if (willDelete) {
        $.ajax({
          url : '<?=Base_url()?>Admin/Testimony/delete/'+id,
        ...
        swal("You canceled delete testimony!");
      }
    });
  }
  ...
  function getById(id)
  {
     swal({
      title: "Are you sure?",
      text: "If you click OK you'll update this testmony / quote",
      icon: "warning",
      buttons: true,
      dangerMode: false,
    })
    .then((willDelete) => {
      if (willDelete) {
        location.href = '<?=Base_url()?>Admin/Testimony/edit/'+id;
      } else {
        swal("You canceled update testimony / quote!");
      }
    });
  }
</script>
