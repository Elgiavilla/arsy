...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <a href="<?=Base_url()?>Admin/Testimony" class="btn btn-primary btn-sm"><i class="fa fa-arrow-left"></i> Back</a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="<?=Base_url()?>Admin/Testimony/update/<?=$testimony->id?>" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Name</label>
                    <input type="text" class="form-control" value="<?=$testimony->name?>" id="exampleInputEmail1" name="name">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Testimony</label>
                    <textarea class="form-control" id="description" rows="3" name="testimony"><?=$testimony->testimony?></textarea>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputFile">Image</label>
                    <br>
                    <img src="<?=Base_url()?>media/Testimony/<?=$testimony->image?>" width="30%">
                    <br>
                    <br>
