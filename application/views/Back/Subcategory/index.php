  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <a href="<?=Base_url()?>Admin/Subcategory/add" class="btn btn-primary btn-lg">Add New Sub Category</a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                foreach($subcategories as $subcategory){?>
                    <tr>
                        ...
                        <td><img src="<?=Base_url()?>media/Subcategory/<?=$subcategory->sub_cat_image?>" width="50%"></td>
                        <td>
                            <a href="#" onclick="getById(<?=$subcategory->sub_category_id?>); return false" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></a>
                            <a href="#" onclick="getDelete(<?=$subcategory->sub_category_id?>); return false" class="btn btn-primary btn-sm"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                <?php }?>
                </tbody>
...
<script>
  ...
  function getById(id)
  {
     swal({
      title: "Are you sure?",
      text: "If you click OK you'll update this category",
      icon: "warning",
      buttons: true,
      dangerMode: false,
    })
    .then((willDelete) => {
      if (willDelete) {
        location.href = '<?=Base_url()?>Admin/Subcategory/edit/'+id;
      } else {
        swal("You canceled update category!");
      }
    });
  }
</script>
