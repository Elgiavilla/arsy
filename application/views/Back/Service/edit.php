        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="<?=Base_url()?>Admin/Service/update/<?=$service->service_id?>" method="POST" enctype="multipart/form-data">
                <div class="card-body">
				  <div class="form-group">
                    <label for="exampleInputEmail1">Category</label>
                    <select name="category_id" class="form-control">
						<option value="<?=$service->category_id?>"><?=$service->name_category?></option>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" value="<?=$service->service_name?>" name="service_name">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" id="itenary" rows="3" name="itenary"><?=$service->itenary?></textarea>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Location</label>
                    <textarea class="form-control" id="location" rows="3" name="location"><?=$service->location?></textarea>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputFile">Image</label>
                    <br>
                    <img src="<?=Base_url()?>media/Service/<?=$service->service_image?>" width="60%">
                    <br>
                    <br>
...
<script>
    function getSubCat(){
        ...
        //alert(cat_id);
        $.ajax({
            url: '<?=Base_url()?>Admin/Service/ajaxSubCat/'+cat_id,
            type: 'GET',
            dataType: 'HTML',
