  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <a href="<?=Base_url()?>Admin/Service/add" class="btn btn-primary btn-lg">Add New Service</a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                foreach($services as $service){?>
                    <tr>
                        ...
                        <td><img src="<?=Base_url()?>media/Service/<?=$service->service_image?>" width="80%"></td>
                        <td>
                            <a href="#" onclick="getById(<?=$service->service_id?>); return false" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></a>
                            <a href="#" onclick="getDelete(<?=$service->service_id?>); return false" class="btn btn-primary btn-sm"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                <?php }?>
                </tbody>
...
<script>
  ...
  function getById(id)
  {
    ...
    .then((willDelete) => {
      if (willDelete) {
        location.href = '<?=Base_url()?>Admin/Service/edit/'+id;
      } else {
