...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <a href="<?=Base_url()?>Admin/Team" class="btn btn-primary btn-sm"><i class="fa fa-arrow-left"></i> Back</a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
              ...
              <form action="<?=Base_url()?>Admin/Team/update/<?=$team->id?>" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="<?=$team->name?>" id="exampleInputEmail1" name="name">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <br>
                    <img src="<?=Base_url()?>media/Team/<?=$team->image?>" width="50%">
                    <br>
                    <br>
