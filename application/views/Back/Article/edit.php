              ...
              <form action="<?=Base_url()?>Admin/Article/update/<?=$article->id?>" method="POST" enctype="multipart/form-data">
                <div class="card-body">
				  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" value="<?=$article->title?>" name="title">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Excerpt</label>
                    <textarea class="form-control" id="" rows="3" name="excerpt"><?=$article->excerpt?></textarea>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Content</label>
                    <textarea class="form-control" id="itenary" rows="3" name="content"><?=$article->content?></textarea>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputFile">Image</label>
                    <br>
					  <img src="<?=Base_url()?>media/Article/<?=$article->image?>"/>
					  <br>
					  <br>
