      ...
      <div class="container">
        ...
        <?php foreach($services as $service){?>
          <div class="col-md-4">
              ...
              <a href="<?=Base_url()?>service/detail/<?=$service->service_slug?>" class="block-20" style="background-image: url('<?=Base_url()?>media/Service/<?=$service->service_image?>');">
              </a>
              <div class="text mt-3 float-right d-block">
              	<div class="d-flex align-items-center pt-2 mb-4 topp">
              	
              	</div>
                <h3 class="heading"><a href="<?=Base_url()?>service/detail/<?=$service->service_slug?>"><?=$service->service_name?></a></h3>
